function inicializar(){
    ...
    var i, max, temp, contenido="", tdelement, respuesta;
    ...
    //numérico y mayor o igual que 2
        ...
        do {
            respuesta = prompt("De que forma los quiere ordenar(1-Ascendende o 2-Descendente):", "");
            //Verificar que se ingrese un dato numérico
            if(isNaN(respuesta)){
            alert("El valor digitado no es numérico.");
            continue; }
            //Verificar que el valor ingresado sea mayor o igual que 2
            if(respuesta > 2){
            alert("Seleccione 1 o 2"); }
            }while(isNaN(respuesta) || respuesta > 2);
...
//Desc
desden = numeros.sort((a, b) => (b || Number.MAX_VALUE) - (a || Number.MAX_VALUE));
...
//ordenados con el método de la burbuja
for(i=0; i<max; i++) {
contenido += "\t\t\t<td class=\"Off\">" + desden[i] + "</td>\n";
}
contenido += "\t\t</tr>\n\t</tbody>\n</table>\n";
